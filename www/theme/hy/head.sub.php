...
<meta name="naver-site-verification" content="f8f2d1877b21e0a06e4c4676d458f63804c7c01f" />
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-0K4X0XK54G"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-0K4X0XK54G');
</script>
...
<!-- 페이지 설명 -->
<meta name="description" content="투엠치과">
<meta name="keywords" content="투엠치과">
<link rel="shortcut icon" href="<?php echo G5_URL?>/favicon.ico"/>
<!-- 오픈그래프 태그, 소셜 미디어로 공유될 때 우선적으로 활용 -->
<meta property="og:type" content="website">
<meta property="og:title" content="투엠치과">
<meta property="og:description" content="투엠치과">
...
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL; ?>/icon.css">
<link type="text/css" href="<?php echo G5_THEME_CSS_URL; ?>/menu_style.css">
<link rel="stylesheet" href="<?php echo G5_THEME_URL; ?>/dist/css/swiper.min-sc4.css">
...
<script src="<?php echo G5_THEME_URL; ?>/dist/js/swiper.min-sc4.js"></script>
<script src="<?php echo G5_THEME_JS_URL ?>/tab.js"></script>
<script src="<?php echo G5_THEME_JS_URL ?>/sub-menu.js"></script>
<script src="<?php echo G5_THEME_JS_URL ?>/menu.js"></script>
<style>
</style>
</head>
